...
- (void)setChartData:(NSArray *)chartData
{
    ...
    if (chartData.count > _maxCount) {
        
        NSIndexSet *set = [NSIndexSet indexSetWithIndexesInRange:NSMakeRange(chartData.count-100, 100)];
        _data = [NSMutableArray arrayWithArray: [chartData objectsAtIndexes:set]];
    } else {
